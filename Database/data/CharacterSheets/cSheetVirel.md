...
Playstyle: Silent Huntress — assassin with scouting and sabotage skills. Stealth, precision, disabling enemies from the shadows.

Former Tribunal Temple Acolyte (Disgraced)
Ashen Veil Survivor (Unofficial)
Telvanni Adjacent Contact (Unconfirmed)
Exile of the Three Fires Doctrine
...
Dark, layered leather and hardened metal plates. Sleek, flexible for agility. Matte finish to reduce light reflection.
Primary Color: Deep indigo-black.
Accent Color: Tarnished silver trims, hints of dark crimson.
Details:
Hooded cowl with a narrow, angled visor for anonymity.
Reinforced shoulder guards with claw-like patterns.
Bracers lined with hidden compartments (for tools like poisons or smoke bombs).
Lightweight chest plate with engraved runes that suppress sound.
Layered half-skirt of leather panels for leg protection without limiting movement.
Slim, articulated boots for quiet steps.
...
- **Primary Weapon**: Obsidian-Tainted Ritual Blade
→ Once used in Tribunal liturgies. Now partially corrupted; strikes leave lingering ash-wounds that weaken magical resistance.

- Throwing Needles: 
→ Laced with alchemical paralytics  
...
- Silt Satchel of Alchemical Residue
→ Carries volatile Ashlander-derived compounds, corrosive powders, and anti-magic salts.

- Twin Glass Vials of Hollow Flame
→ Unstable alchemical fire that burns soul residue rather than flesh. Effective against undead and bound spirits.
...
Ashstep
→ Short-range blink through ash, smoke, or shadowed particles. Leaves behind a fading silhouette that confuses attackers.

Tribunal Echo (Broken Prayer)
→ Releases distorted remnants of Temple hymns. Weakens enemy concentration and disrupts spellcasting within a small radius.

Cinder Mark
→ Brands an enemy with a metaphysical ash sigil. Virel can track them through walls and detect their emotional state when nearby.

Veil of Forgotten Divinity
→ Cloaks Virel in light-dampening shadow. Temporarily suppresses divine detection and reduces visibility to magic-based senses. Most effective against clerics and daedra.

Umbral Sever
→ A precise shadow-infused strike that disrupts magical bindings, wards, or summoned entities.

Ashen Reminiscence
→ Draws on fragmented ancestral memory; briefly increases reflexes and combat prediction at the cost of emotional instability.

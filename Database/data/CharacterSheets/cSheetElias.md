...
**Affiliations:**
- Vigilant of Stendarr (Honorary / Former Initiate)
- Dark Brotherhood (Deep Cover Operative)
- Namiran Acolyte (Secret Devotion)
...
- **Status:** Traveling with Virel in Falkreath hold  
- **Goal:** Track the origin of Namiran corruption spreading through hidden cult cells  
...
**Radiant Destruction**  
→ Meridia-aligned energy manipulation effective against undead, daedra, and corrupted entities.

**Illusion Counter-Weaving**  
→ Resistance to mental manipulation and fear-based magic through structured will discipline.
...
**Radiant Slash**  
→ Blade strike infused with solar force; disrupts necrotic energy and suppresses shadow magic in impact zone.
...
**Namira’s Caress**  
→ Converts surrounding suffering into regenerative force; enhances endurance in prolonged combat scenarios.

**Shadow Meld**  
→ Reduces visibility and magical detection by synchronizing with environmental darkness.

**Whispers of the Fleshless**  
→ Communes with recently deceased spirits to extract memory fragments, warnings, or unresolved truths.
